  ...
  return (
    <ScrollView stickyHeaderIndices={[0]} style={{ backgroundColor: '#F5F5F5', flex: 1 }}>
      ...
      <SwitchButtonMemo
        ...
        getSwitch={roomkitAction.setIsMicrophoneOnWhenJoiningRoom.bind(null,!roomSettings.isMicrophoneOnWhenJoiningRoom)}
        style={styles.mgt10}
        content={i18n.t('roomkit_setting_room_mic_off_when_joining')}
      />
      <SwitchButtonMemo
        value={!roomSettings.isCameraOnWhenJoiningRoom}
        getSwitch={roomkitAction.setIsCameraOnWhenJoiningRoom.bind(null,!roomSettings.isCameraOnWhenJoiningRoom)}
